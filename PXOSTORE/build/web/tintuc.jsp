    ...
    <body style="background : url(video/background.jpg) fixed">
        <jsp:include page="header.jsp"></jsp:include>
            <div id="top-phongthuy">
                <a href="index.jsp" style="color: white; font-size: 40px; "><strong>Home ></strong></a><span style="font-size : 40px"> Tin Tức</span>
            </div>
        <%
        ...
        <div id="bottom-phongthuy">
            <div>
                <div class="image">
                    <image  src="<%=x.getXaydung_kientruc_Image() %>" style="height : 240px; width: 240px;" ></image>
                </div>
                <div style="margin-left:239px;">
                    <a href="tintuc1.jsp?id=<%=x.getiD_xaydung_kientruc() %>"><p class="tieude" style="margin-bottom:10px; color: red; font-weight: bold; font-size: 30px "><%=x.getXaydung_kientruc_TieuDe() %></p></a>
                    <div>
                        <p class="noidung">
                            <%=x.getXaydung_kientruc_NoiDung() %>
                        <div><a href="tintuc1.jsp?id=<%=x.getiD_xaydung_kientruc()  %> "><span style="color : white;"><br>Đọc Tiếp...</br></span></a></div>
                        </p>
                    </div>
                    <div class="clear"></div>
                </div>
