        ...
        <div id="content" style="background:rgba(0,0,0,0)">
            ...
            <div >
                <div >
                    ...
                    <a href="insert_thanhvien_Admin.jsp" style="color:red; font-size: 15px ">Thêm Thành Viên</a>
                    ...
                    <table id="baidang">
                        ...
                        <tr style="color:white;">
                            ...
                            <td><%=u1.getUserPass()%><span><a href="update_thanhvien_userpass_Admin.jsp?lenhsql=suauserpass&userID=<%=u1.getStt()%>"><i class="far fa-edit"></i></a></span></td>
