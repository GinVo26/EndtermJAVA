    ...
    <body style="background:url(video/bann.jpg) fixed">
        ...
        <div id="content" style="background:rgba(0,0,0,0)">
            ...
            <div>
                <h3>Danh Mục</h3>
                <table id="danhmuc">
                    <a href="insert_category_Admin.jsp"><i class="fas fa-plus-square">Thêm Danh Mục</i></a>
                    <tr>
                        <th>Số Thứ Tự</th>
                        <th>Tên Danh Mục</th>
                        <th>Công Cụ</th>
                    ...
                    <tr>
                        ...
                        <td><span><a href="update_category1_Admin.jsp?command=update&category_id=<%=cd.getCategoryID()%>"><i class="far fa-edit"></i></a></span>|||<span><a href="ManagerCategoryServlet?command=delete&category_id=<%=cd.getCategoryID()%>"><i class="fas fa-trash-alt"></i></a></span></td>
                    </tr>
                    <% }%>
                </table>
            </div>
