    ...
    <body>
        ...
        <div id="sidebar" style="margin-top:-654px;" ><a href="#" class="visible-phone"><i class="icon icon-home"></i> Thống Kê</a>
            <ul>
                ...
                <li><a href="manager_category_Admin.jsp"><i class="icon icon-th" style="color: white;"></i> <span style="color: white;">Quản Lý Danh Mục Điện Thoại</span></a></li>
                <li><a href="manager_category1_Admin.jsp"><i class="icon icon-th" style="color: white;"></i> <span style="color: white;">Quản Lý Danh Mục Tablet</span></a></li>
                <li><a href="manager_product_Admin.jsp"><i class="icon icon-th" style="color: white;"></i> <span style="color: white;">Quản Lý Điện Thoại</span></a></li>
                <li><a href="manager_product1_Admin.jsp"><i class="icon icon-th" style="color: white;"></i> <span style="color: white;">Quản Lý Tablet</span></a></li>
