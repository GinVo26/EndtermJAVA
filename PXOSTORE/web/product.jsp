        ...
        <div class="container">
            <div class="content">
                <div class="content-top">
                    ...
                    <h3 class="future"><strong style="color: black; margin-left: 60px"></strong></h3>
                    <%
                    ...
                    <div class="col-md-3 md-col" style="margin-top:30px;">
                            <div  class="col-md" style="background:rgba(0,0,0,0.4)">
                                ...
                                <div class="top-content">
                                    <h5><a style="color:white; font-size: 20px; " href="single.jsp?productID=<%=p.getProductID()%>"><%=p.getProductName()%></a></h5>
                                    ...
                                    <div class="white">
                                        ...
                                        %>
                                        <p class="dollar"><span><%=p.getProductPrice()%></span><span>Tr</span><span class="in-dollar">VNĐ</span></p>
                                        <div class="clearfix"></div>
                                    </div>
                                    <%
                                        }
