                    ...
                    <div class="header-top-in">			
                        ...
                        <div class="header-in">
                            <ul class="icon1 sub-icon1">
                                ...
                                <li  > <a href="GioHang.jsp" style="    border-top: 1px solid black;border-left:1px solid black;border-bottom: 1px solid black;height: 43px;">Giỏ Hàng</a></li>
                                <li ><div class="cart" style="border-right: 1px solid black;border-top:1px solid black;border-bottom: 1px solid black;">
                                        <a href="#" class="cart-in"></a>
                                        <span><% cart.countItem(); %></span>
                                    </div>
                                    <ul class="sub-icon1 list" style="width:319px;top:46px;background:rgba(0,0,0,0.4)">
                                        <h3 style="color:#fdfaf9;border-bottom: 2px solid white;">Giỏ hàng</h3>
                ...
                <div class="container">
                    <div class="h_menu4">
                        ...
                        <ul class="nav">
                            ...
                            <li id="s" style="background:rgba(0,0,0,0.4);color:white;"><a id="menu" href="#"  >MÁY TÍNH BẢNG</a>
                                <ul class="drop" style="background:rgba(0,0,0,0.4);">
                                    <%
                                        for (Category c : CategoryDAO.getListCategoryChoThue()) {
                                    %>
                                    <li id="s" style="background:rgba(0,0,0,0.4);"><a id="menu" href="product1.jsp?category=<%=c.getCategoryID()%>"><%=c.getCategoryName()%></a></li>
                                        <%
                                            }
                                        %>            
                                </ul>
                            ...
                            <li id="s" style="background:rgba(0,0,0,0.4);color:white;"><a id="menu" href="tintuc.jsp"  >Tin Tức </a></li>
                ...
                <div class="container">
                    ...
                    <div class="header-bottom-on" >
                        ...
                        <div class="clearfix"></div>
                            ...
                            <div class="header-bottom-on" style="padding: 0px">
