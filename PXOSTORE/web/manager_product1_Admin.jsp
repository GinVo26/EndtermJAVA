...
<html>
    ...
    <body style="background:url(video/bann.jpg) fixed;color:white;">
        <%
            ChoThueDAO chothueDAO = new ChoThueDAO();
            ArrayList<ChoThue> list = chothueDAO.GetALlList();
        %>
        ...
        <div id="content" style="background:rgba(0,0,0,0)">
            ...
            <div>   
                ...
                <h3 style="color:white;">Danh Sách Sản Phẩm</h3>
                <table id="danhmuc">
                    <tr>
                        <th>Số Thứ Tự</th>
                        <th>Bài Đăng</th>
                    ...
                    <tr>
                        ...
                        <td><%
                            ...
                            %>
                            <span><a href="QuanLi?command=xoa&ChoThueID=<%=request.getParameter("ChoThueID")%>"><i class="fas fa-trash-alt">Xóa</i></a></span></td>
