            ...
            <%response.setContentType("text/html; charset=UTF-8"); %>
                <div class="container" >
                    <div class="account">
                        ...
                        <div> 
                            <span class="word" style="color:white;">Password *</span>
                        ...
                        <div> 
                            <span class="word" style="color:white;">Nhập Lại Password *</span>
                        ...
                        <input id="tb" style="background:rgba(0,0,0,0.4);border:1px solid black;" class="button" type="submit" value="Đăng Ký"> 
                    </form>
                </div>
            </div>
        </div>
