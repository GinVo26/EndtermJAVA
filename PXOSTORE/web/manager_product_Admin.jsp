        ...
        <div id="content" style="background:rgba(0,0,0,0)">
            ...
            <div>   
                ...
                <table id="danhmuc">
                    ...
                    <tr>
                        <td><%=countt%></td>
                        <td><img style="width:100px;height:50px;" src="<%=p.getProductImage()%>" >
                        ...
                        <td><%
                            ...
                            %>
                            <span><a href="QuanLi?command=xoa&ProductID=<%=request.getParameter("ProductID")%>"><i class="fas fa-trash-alt">Xóa</i></a></span></td>
